  ...
  return (
    <section className="w-full h-auto flex flex-col bg-black justify-center items-center">
      ...
      <div className="w-full h-[120px] flex flex-col justify-center items-center">
        <h1 className="font-bold bg-gradient-to-b from-neutral-200 to-neutral-500 bg-clip-text text-transparent tracking-tight text-6xl z-50 text-center mb-10">
      ...
      <div className="w-full h-[300px] flex justify-center items-center absolute top-56">
        <Lottie
