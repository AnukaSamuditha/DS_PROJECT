    ...
    <div className="w-full rounded-[12px] p-4 flex flex-col gap-3 bg-[#F7F7F7]">
      <div className="w-full flex justify-between items-center">
        ...
        <div
          ...
          } ${order.status === "order_accepted" && "bg-orange-400"}`}
        >
          <div className="rounded-full bg-blue-300 w-2.5 h-2.5 flex justify-center items-center animate-pulse"></div>
      ...
      <div>
        <h3 className="text-sm text-gray-400 tracking-tight font-medium">Amount : Rs.{order && order.totalAmount}</h3>
          <div className="w-full h-[4rem] flex justify-start items-center mt-4 gap-3">
            <div className="w-auto h-full flex flex-col justify-between items-center">
			 ...
			 <h6 className="text-xs font-normal text-gray-400">{order && order.distanceFromShopToUser}</h6>
            </div>
			...
			<div className="w-auto h-full flex flex-col justify-between items-center">
				<h5 className="text-xs font-medium tracking-tight text-black">{order && order.shop.location.address}</h5>
				<h5 className="text-xs font-medium tracking-tight text-black">{order && order.user.location.address}</h5>
			</div>
          </div>
      </div>
    </div>
