...
import Item from "@/components/orders/Item.jsx";
...
export default function MyOrders() {
  ...
  const { data, isLoading, isError, error } = useQuery({
    queryKey: ["my-orders"],
    queryFn: async () => {
      const res = await axios.get(`${import.meta.env.VITE_ORDERING_SERVICE_PREFIX}/orders/my-orders`, {
  ...
  const deleteMutation = useMutation({
    mutationFn: async (id) => {
      await axios.delete(`${import.meta.env.VITE_ORDERING_SERVICE_PREFIX}/orders/${id}`, {
        withCredentials: true,
      });
    },
    onSuccess: () => {
  ...
  const updateMutation = useMutation({
    mutationFn: async ({ id, data }) => {
      await axios.patch(`${import.meta.env.VITE_ORDERING_SERVICE_PREFIX}/orders/${id}`, data, {
        withCredentials: true,
      });
    },
    onSuccess: () => {
