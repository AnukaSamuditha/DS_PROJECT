...
const {createOrder,updateOrder,getOrder,getOrderStatus, getDayOrders} = require('../Controllers/orderController');
...
router.get("/day/:id",authenticate,authorize(["driver",]),getDayOrders);
